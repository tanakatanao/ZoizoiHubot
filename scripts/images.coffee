...
module.exports = (robot) ->
  ...
  robot.hear /疲れた(.*?)/i, (msg) ->
    msg.send 'お疲れですぞい？\nこれでも見て元気出すぞい'
    word = msg.random ['癒される','可愛い','女の子','猫','犬','カピバラ','アルパカ','かわいい　声優','空飛ぶ犬','コーギー　お尻','アライグマ　ぷうた','ウォンバット　だっこ','流しカワウソ','ハムケツ','柴犬　のびる','犬　帰りたくない','猫　コンビニ','セノーテ','力士　かわいい','橋本環奈','デートなうに使っていいよ','美女','若手女優']
